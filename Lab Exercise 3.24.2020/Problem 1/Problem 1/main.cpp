...
void fillArray(int *a)
{
	...
	//Loop through the array storing a random number (1 to 1000) in *ptr
...
void printArray(int *a)
{
	...
	//Set pFirst to start of array
	//Add code here


	//Set pLast to end of array
	//Add code here

	while (pFirst <= pLast)	//Check to see if pFirst at end of array
	{
		//Output array element using *pFirst
		//Add code here

		//Move pointer pFirst to next element
		//Add code here					
	}	
}
