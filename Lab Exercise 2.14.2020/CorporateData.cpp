//Lab Exercise 2/14/2020 Problem 2
//Author: nmessa
...
struct CorpData
{
	...
	void display()
	{
		...
		cout << "Division Name: " << name << endl;
		cout << "First Quarter Sales: $" << q1Sales << endl;
		cout << "Second Quarter Sales: $" << q2Sales << endl;
		cout << "Third Quarter Sales: $" << q3Sales << endl;
		cout << "Fourth Quarter Sales: $" << q4Sales << endl;
		cout << "Total Annual Sales: $" << totalSales << endl;
		cout << "Average Quarterly Sales: $" << average << endl;
		cout << endl << endl;
	}
};
